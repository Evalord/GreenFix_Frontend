...
const Collection1Page = () => {
  const handleCollectionSubmit = (data) => {
    console.log("Collection 1 Data Submitted:", data);
    // Add logic to send data to the backend or update state
    alert("Collection 1 data submitted successfully!");
  };

  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Collection 1 Process</h1>
      <p className={styles.description}>
        Please fill out the form below to record the details for Collection 1.
      </p>
